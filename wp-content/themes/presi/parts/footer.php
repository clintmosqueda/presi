      ...
      <div class="footer-top-inner">
        <a class="footer-link footer-contact" href="<?php echo resolve_url('contact'); ?>">
          ...
          <div class="footer-link-content">
            ...
            <p class="footer-link-desc">土地の売却を検討されている方
            不動産土地活用をしたいとお考えの方</p>
            <span class="footer-link-par">PRESIへのご質問など、お気軽にお問い合わせください。</span>
          </div>
        </a>
        ...
        <a class="footer-link footer-recruit" href="http://presi.co.jp/recruit/" target="_blank">
          ...
          <div class="footer-link-content">
            ...
            <p class="footer-link-desc">社会人として大きな成功を手にしたい</p>
            <span class="footer-link-par">そんな野心を抱く新卒者が選ぶべきは、PRESIしかありません。
            「PRESI」はさらなる成長を促進する若き力を本気で求めています。</span>
          </div>
        </a>
